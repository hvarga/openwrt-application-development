...
\begin{frame}{Preparing Host}
    ...
    \begin{itemize}[<+-|alert@+>]
        ...
        \begin{itemize}
        \item \inlinecode{git clone https://git.openwrt.org/openwrt/openwrt.git}
        \end{itemize}
        \item Checkout latest stable version.
        \begin{itemize}
            \item \inlinecode{git checkout v17.01.4}
        \end{itemize}
    \end{itemize}
\end{frame}
...
\begin{frame}{Configuring Build System}
    ...
    \begin{itemize}[<+-|alert@+>]
        ...
        \begin{itemize}
            \item \inlinecode{make menuconfig}
        \end{itemize}
    \end{itemize}
\end{frame}
...
\begin{frame}[fragile]{Building and Running Image}
    \pause
    \begin{itemize}[<+-|alert@+>]
        \item It is assumed that you have choosen \inlinecode{MIPS Malta CoreLV board (qemu)} for Target System.
        ...
        \begin{itemize}
            \item \inlinecode{cd ./bin/targets/malta/le}
            \item \inlinecode{qemu-system-mipsel -kernel lede-malta-le-vmlinux-initramfs.elf -nographic}
        \end{itemize}
    \end{itemize}
\end{frame}